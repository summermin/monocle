...
(function() {
  $(document).on('ready page:load', function() {
    var charityTexts, goalTexts, index, moneyTexts, nextGoal, showGoal, timeTexts;
    if ($('.front-page-call-to-action').length > 0) {
      ...
      showGoal = function() {
        ...
        $('span.highlighted.goal-text .value').fadeOut(1000, function() {
          $('span.highlighted.goal-text .value').text(goalTexts[index]);
          return $('span.highlighted.goal-text .value').fadeIn(2000);
        });
        $('span.highlighted.time-period-text .value').fadeOut(1000, function() {
          $('span.highlighted.time-period-text .value').text(timeTexts[index]);
          return $('span.highlighted.time-period-text .value').fadeIn(2000);
        });
        $('span.highlighted.monetary-amount-text .value').fadeOut(1000, function() {
          $('span.highlighted.monetary-amount-text .value').text(moneyTexts[index]);
          return $('span.highlighted.monetary-amount-text .value').fadeIn(2000);
        });
        return $('span.highlighted.charity-name-text .value').fadeOut(1000, function() {
          $('span.highlighted.charity-name-text .value').text(charityTexts[index]);
          return $('span.highlighted.charity-name-text .value').fadeIn(2000);
        });
      };
      index = 0;
      nextGoal = function() {
        showGoal();
        return index = (index + 1) % goalTexts.length;
      };
      showGoal();
      return window.setInterval(nextGoal, 7500);
    }
  });
